...
class Services_V3 extends Widget_Base {
    ...
    ============================================== 
    -->
    <div class="<?php if($settings['style_two'] == 'two') echo ' fancy-feature-twentyFive position-relative mt-80 lg-mt-80'; else echo 'fancy-feature-thirteen position-relative mt-80 pb-80 lg-pb-80'; ?>">
        <div class="container">
            <?php if($settings['subtitle'] || $settings['title']) { ?>
            <div class="row">
                <div class="col-xl-6 col-lg-5 col-md-7 m-auto" data-aos="fade-up">
                    <div class="title-style-one text-center mb-20 lg-mb-20">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 d-flex" data-aos="fade-up">
                    <div class="block-style-ten tran3s mt-20">
